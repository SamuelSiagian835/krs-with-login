...
<div class="bg-white shadow">
  <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
    <h1 class="text-3xl font-bold tracking-tight text-gray-900">Course List
...
$query = "SELECT id, course_name, credit_hours FROM course";
...
echo "<form action= method='post'>"; // Add form tag and nim parameter in the action URL
echo "<table>";
